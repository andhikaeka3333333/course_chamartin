<footer class="bg-white py-10 border-t border-gray-200">
    <div class="container mx-auto px-6 lg:px-20 flex flex-col lg:flex-row justify-between">
      ...
      <div>
        ...
        <div class="flex items-center mb-2">
            ...
            <h1 class="text-2xl font-bold  mb-4 mr-4 text-[#2d3e50]">Chamartin</h1>
        </div>
        ...
        <div class="mb-4">
          <p class="flex items-center text-gray-600">
            ...
            <a href="mailto:chamartin_course@gmail.com" target="_blank" class="hover:underline text-blue-600 font-medium ">Email</a>
          </p>
          <p class="text-sm text-gray-500 ">chamartin_course@gmail.com</p>
        </div>
        ...
        <div>
          <p class="flex items-center text-gray-600">
            ...
            <a href="https://wa.me/6285656596197" target="_blank" class="hover:underline text-blue-600 font-medium ">Whatsapp</a>
          </p>
    ...
    <div class="py-4"></div>
      ...
      <div class="grid grid-cols-3 gap-6 text-gray-800 text-sm">
        <div>
            <h2 class="font-semibold mb-4 mr-4 text-lg text-[#2d3e50]">Chamartin</h2>
          <ul>
            <li class="mb-2 ">  <a href="{{ url('about#about') }}" class="hover:underline">About</a></li>
            <li class="mb-2 ">  <a href="{{ url('/#faq') }}" class="hover:underline">FAQ</a></li>
            <li class="mb-2 ">  <a href="{{ url('purpose') }}" class="hover:underline">Purpose</a></li>
          </ul>
        </div>
        <div>
          <h2 class="font-semibold mb-4 text-lg  text-[#2d3e50]">Layanan</h2>
          <ul>
            <li class="mb-2 "><a href="{{ route('login') }}" class="hover:underline">Home</a></li>
            <li class="mb-2 "><a href="/materi" class="hover:underline">Learning</a></li>
            <li class="mb-2 "><a href="/event" class="hover:underline">Event</a></li>
            <li class="mb-2 "><a href="/merchandise" class="hover:underline">Merchandise</a></li>
          </ul>
        </div>
        <div>
