        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="bg-[#2d3e50] text-gray-100 rounded-lg p-6 shadow-lg">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <!-- Berita Coding -->
                    <div>
                        <h2 class="text-lg font-semibold mb-4 font-poppins flex items-center text-white">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="bg-white rounded-lg p-4 shadow-md">
                                ...
                                <h3 class="font-poppins text-[#2d3e50] font-medium text-lg mt-4">Coding & AI Masuk Kurikulum</h3>
                            ...
                            <div class="bg-white rounded-lg p-4 shadow-md">
                                ...
                                <h3 class="font-poppins text-[#2d3e50] font-medium text-lg mt-4">Variasi Pembelajaran Coding</h3>
