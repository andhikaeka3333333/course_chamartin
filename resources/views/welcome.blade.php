    ...
    <ul class="px-2 md:px-24 py-6">
        <li>
            <details class="p-2 bg-gray-100 my-3 hover:cursor-pointer rounded-md">
                ...
                <p class="p-2 text-gray-700">
                    Chamartin adalah platform kursus online yang berfokus pada pembelajaran web development. Kami
                    menawarkan kursus gratis dengan modul interaktif yang dirancang untuk semua level, mulai dari pemula
                    hingga mahir.
                </p>
            </details>
        </li>
        ...
        <li>
            <details class="p-2 bg-gray-100 my-3 hover:cursor-pointer rounded-md">
                ...
                <p class="p-2 text-gray-700">
                    Website Chamartin dibangun menggunakan Laravel sebagai framework backend dan Tailwind CSS untuk
                    styling serta menggunakan Mysql.
                </p>
            </details>
        </li>
        <li>
            <details class="p-2 bg-gray-100 my-3 hover:cursor-pointer rounded-md">
                ...
                <p class="p-2 text-gray-700">
                    Semua orang dapat mengikuti kursus di Chamartin, baik pemula maupun yang ingin memperdalam
                    pengetahuan tentang web development.
                </p>
            </details>
        </li>
        <li>
            <details class="p-2 bg-gray-100 my-3 hover:cursor-pointer rounded-md">
                ...
                <p class="p-2 text-gray-700">
                    Ya, Chamartin memiliki komunitas belajar yang aktif untuk berbagi ilmu dan saling mendukung dalam
                    perjalanan belajar web development.
                </p>
            </details>
        </li>
    </ul>
